...
link:
	g++ $(CXXFLAGS) $(SOURCE).o header.o Button.o SLL.o DataVisualization3.o Textbox.o Globals.o DataVisualization4.o DLL.o DataVisualization5.o CLL.o Stack.o DataVisualization6.o Queue.o DataVisualization7.o -o main -L $(LIBRARY) $(SFMLFLAGS) $(SFML_INCLUDE)
